...
const ROLE_DEFAULTS: Record<string, RuntimeProfile> = {
  ...
  reviewer: { thinking: true, temperature: 0.05, topP: 0.75, variant: "strict" },
  qa: { thinking: true, temperature: 0.05, topP: 0.75, variant: "strict" },
  security: { thinking: true, temperature: 0.05, topP: 0.75, variant: "strict" },
  tester: { thinking: true, temperature: 0.05, topP: 0.75, variant: "strict" },
