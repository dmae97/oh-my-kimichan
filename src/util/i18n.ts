...
const en: Record<string, string> = {
  ...
  "cli.skillDesc": "Kimi skill pack manager",
  ...
  "cmd.syncGlobalOption": "Sync global Kimi assets (~/.kimi/)",
  ...
  "cmd.reviewCiOption": "Run in CI mode (no Kimi API calls, local checks only)",
  ...
  "cmd.skillDesc": "[Experimental] Manage Kimi skill packs",
...
const ko: Record<string, string> = {
  ...
  "cmd.syncGlobalOption": "글로벌 Kimi assets 동기화 (~/.kimi/)",
  ...
  "cmd.reviewCiOption": "CI 모드로 실행 (Kimi API 호출 없이 로컬 검증만 수행)",
  ...
  "index.symbolsGenerated": "Symbol index generated",
  "index.symbolCount": "Symbols indexed",
  "cmd.skillDesc": "[Experimental] Kimi 스킬 팩 관리",
